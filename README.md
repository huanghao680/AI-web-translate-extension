...
- **划选翻译** — 选中文本后点击浮动「翻译」按钮确认，精确翻译选区范围，支持原文/译文切换
...
- **翻译提示** — 页面加载时弹出蓝色翻译提示条，检测到页面已是目标语言时自动跳过
...
- **整页翻译**: 点击插件图标 → 点击"整页翻译"
- **划选翻译**: 点击插件图标 → 点击"划选翻译" → 在页面上选中文本 → 点击弹出的「翻译」按钮确认
...
- **翻译提示**: 在设置中开启"自动翻译"，页面加载时弹出蓝色翻译提示条，点击"翻译"按钮确认后执行
...
1. 点击弹窗"划选翻译"进入选择模式
2. 在页面上用鼠标选中任意文本
3. 选中区域下方弹出蓝色浮动「翻译」按钮
4. 点击「翻译」确认后，仅对选区范围内的文本节点进行翻译
5. 翻译结果与整页/块翻译共享原文/译文切换
6. Esc 退出选择模式
...
3. 页面已是目标语言 → 跳过
4. 弹出蓝色 banner 提示条，点击「翻译」按钮开始整页翻译
